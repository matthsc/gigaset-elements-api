...
async function loadJsonFile<T = unknown>(
...
export function loadBaseStations(parse?: boolean) {
  return loadJsonFile<IBaseStationRoot>("base-stations", parse);
}
...
export function loadElements(parse?: boolean) {
  return loadJsonFile<IElementRoot>("elements", parse);
}
...
export function loadEvents(parse?: boolean) {
  return loadJsonFile<IEventRoot>("events", parse);
}
